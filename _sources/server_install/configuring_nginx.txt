...
And with this you have FoOlFuuka running from
``http://archive.foolz.us``. Let’s say instead that you want FoOlFuuka
in a subfolder, like ``http://foolz.us/foolfuuka``. Here’s how to go
with it:
